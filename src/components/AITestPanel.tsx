...
export const AITestPanel: React.FC<AITestPanelProps> = ({ prompt, aiType }) => {
  ...
  return (
    <div className="glass-ultra rounded-2xl shadow-depth overflow-hidden shadow-glow-pink animate-shimmer">
      <div className="px-responsive py-4 sm:py-5 bg-gradient-to-r from-gray-800/30 to-gray-700/30 border-b border-white/5">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="p-2 sm:p-3 text-gray-400 hover:text-gray-200 glass-card hover:glass-button rounded-lg transition-all duration-300 interactive focus-ring"
      ...
      {showApiSettings && (
        <div className="px-responsive py-4 bg-gradient-to-r from-yellow-900/20 to-orange-900/20 border-b border-yellow-500/20">
          <div className="text-responsive-sm text-yellow-200">
            ...
            <div className="space-y-2 text-responsive-xs glass-input p-3 rounded-lg border border-yellow-600/30">
            ...
            <div className="mt-3 flex items-center space-x-3">
              <div className={`w-3 h-3 rounded-full ${hasApiKey() ? 'bg-green-400 shadow-glow' : 'bg-red-400 shadow-glow'} animate-pulse`}></div>
      ...
      <div className="p-responsive space-y-5">
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 sm:px-5 sm:py-4 glass-input rounded-xl focus:ring-2 focus:ring-pink-500/50 focus:border-pink-400/50 transition-all duration-300 text-gray-100 placeholder-gray-400 hover:border-gray-500/50 resize-none focus-ring"
          />
        </div>
        ...
        <button
          ...
          className={`w-full flex items-center justify-center space-x-3 px-4 py-4 sm:px-6 sm:py-5 rounded-xl font-medium transition-all duration-300 focus-ring ${
            isLoading || !prompt.trim() || !hasApiKey()
              ? 'glass-input text-gray-500 cursor-not-allowed'
              : 'glass-button text-white shadow-glow-pink interactive'
          }`}
        >
          {isLoading ? (
            <>
        ...
        {result && (
          <div className="space-y-4">
            ...
            <div className="glass-input rounded-xl p-4 sm:p-5 max-h-64 sm:max-h-96 overflow-y-auto border border-white/5">
